...
class OverridePanel(QWidget):
    ...
    def _build_ui(self):
        ...
        self.override_spinner.setToolTip("Select bucket number (0 = auto-assign)")
        row.addWidget(self.override_spinner)
        btn = QPushButton("Apply")
        btn.setToolTip("Apply bucket override to selected tag(s)")
        ...
        btn2.setToolTip("Remove override and revert to auto-bucket")
        ...
        brn.setToolTip("Rename selected tag(s) to the new name")
        ...
        self.merge_input.setToolTip("Enter the target tag to merge selected tags into")
        mr.addWidget(self.merge_input)
        bm = QPushButton("Merge Selection")
        bm.setToolTip("Merge all selected tags into the target tag")
        ...
        self.search_input.setToolTip("Substring to search for in all tags")
        sr.addWidget(self.search_input)
        self.replace_input = QLineEdit()
        self.replace_input.setPlaceholderText("Replace with...")
        self.replace_input.setToolTip("Replacement text (leave empty to remove matches)")
        sr.addWidget(self.replace_input)
        bs = QPushButton("Replace")
        bs.setToolTip("Replace all occurrences across all tags")
        ...
        self.bucket_name_input.setToolTip("Set the folder name used for all export buckets")
        bnr.addWidget(self.bucket_name_input)
        bbn = QPushButton("Apply to All")
        bbn.setToolTip("Apply this name to all bucket folders")
        ...
        bsc.setToolTip("Save overrides, deleted tags, and paths to a JSON file (Ctrl+S)")
        bsc.clicked.connect(self.save_config.emit)
        cr.addWidget(bsc)
        blc = QPushButton("Load Config")
        blc.setToolTip("Load a previously saved configuration (Ctrl+O)")
