...
def analyze_dataset(
    ...
    if portrait_pct >= 80:
        suggestions.append(
            f"{portrait_pct:.0f}% of your images are in portrait orientation. "
            "Add landscape or square images for more diversity."
        )
    elif landscape_pct >= 80:
        suggestions.append(
            f"{landscape_pct:.0f}% of your images are in landscape orientation. "
            "Add portrait or square images for more diversity."
        )
    elif square_pct >= 80:
        suggestions.append(
            f"{square_pct:.0f}% of your images are square. "
            "Add portrait or landscape images for more diversity."
        )
    ...
    if small_pct >= 50:
        suggestions.append(
            ...
            "Use larger images for better training."
        )
...
def format_report(analysis: dict[str, Any]) -> str:
    ...
    if rs.get("min"):
        ...
        _add(f"  Avg  : {rs['mean'][0]}×{rs['mean'][1]}")
        _add("")
